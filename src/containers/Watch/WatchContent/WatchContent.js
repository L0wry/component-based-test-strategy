...
import * as serchAction from '../../../store/actions/search';
    ...
    return (
      <InfiniteScroll bottomReachedCallback={this.props.bottomReachedCallback} showLoader={this.shouldShowLoader()}>
        <div className='watch-grid'>
          ...
          <Comments addComment={this.props.addComment}c lassName='comments' comments={this.props.comments} amountComments={this.props.amountComments} />
        </div>
      </InfiniteScroll>
    );
  }
